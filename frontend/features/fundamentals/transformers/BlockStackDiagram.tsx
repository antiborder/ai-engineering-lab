  ...
  return (
    <div className="w-full max-w-[300px] mx-auto">
      <svg viewBox={`0 0 ${width} ${height}`} className="bg-white rounded-md border border-neutral-200 w-full h-auto">
        <text x={width / 2} y={16} fontSize={14} textAnchor="middle" fill="#3f3f46">
          token vectors in
        </text>
        ...
        {Array.from({ length: numBlocks }, (_, i) => {
          ...
          return (
            <g key={i}>
              ...
              />
              <text x={width / 2} y={y + boxH / 2 + 4} fontSize={14} textAnchor="middle" fill="#3f3f46">
        ...
        <line
          ...
          strokeWidth={2}
        />
        <text x={width / 2} y={height - 2} fontSize={14} textAnchor="middle" fill="#3f3f46">
