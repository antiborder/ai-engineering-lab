        ...
        {Array.from({ length: BLOCKS }, (_, b) => {
          ...
          return (
            <g key={b}>
              ...
              <text x={blockX + 10} y={top + 14} fontSize={10} fontWeight={700} fill="#525252">
                Block {b + 1}
              </text>

              <rect x={sublayerX} y={sub1Y} width={sublayerW} height={sublayerH} rx={6} fill="rgba(8,145,178,0.1)" stroke={CYAN} strokeWidth={2} />
              <text x={midX} y={sub1Y + 18} fontSize={11} textAnchor="middle" fill="#3f3f46">
                Attention
              </text>
              <text x={midX} y={sub1Y + 33} fontSize={9} textAnchor="middle" fill={ORANGE}>
                + residual, norm
              </text>
              ...
              <text x={midX} y={sub2Y + 18} fontSize={11} textAnchor="middle" fill="#3f3f46">
                Feed-Forward
              </text>
              <text x={midX} y={sub2Y + 33} fontSize={9} textAnchor="middle" fill={ORANGE}>
                + residual, norm
              </text>
