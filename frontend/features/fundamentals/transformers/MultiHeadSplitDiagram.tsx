  ...
  return (
    <div className="w-full max-w-[460px] mx-auto">
      <svg viewBox={`0 0 ${width} ${height}`} className="bg-white rounded-md border border-neutral-200 w-full h-auto">
        <text x={width / 2} y={topY - 4} fontSize={10} fill="#525252" textAnchor="middle">
        ...
        {Array.from({ length: HEADS }, (_, h) => {
          ...
          return (
            <g key={h}>
              ...
              <text x={groupCenterX} y={headBoxY + headBoxH / 2 - 4} fontSize={10} fontWeight={700} textAnchor="middle" fill={color}>
                Head {h + 1} attention
              </text>
              <text x={groupCenterX} y={headBoxY + headBoxH / 2 + 10} fontSize={8.5} textAnchor="middle" fill="#525252">
        ...
        <text x={width / 2} y={outY + cellH + 14} fontSize={10} fill="#525252" textAnchor="middle">
        ...
        <text x={width / 2} y={finalY + cellH + 14} fontSize={10} fontWeight={700} fill={NEUTRAL} textAnchor="middle">
