...
export function WorkflowVsAgentDiagram() {
  return (
    <div className="w-full max-w-75 mx-auto space-y-3">
      <div>
        <div className="text-xs font-semibold uppercase tracking-wide text-purple-700 text-center mb-1">
        ...
        <svg viewBox="0 0 300 150" className="bg-white rounded-md border border-neutral-200 w-full h-auto">
          ...
          <text x={150} y={22} fontSize={12} textAnchor="middle" fill="#3f3f46">Start</text>
          ...
          <text x={150} y={66} fontSize={12} textAnchor="middle" fill="#3f3f46">Task A</text>
          ...
          <text x={150} y={148} fontSize={12} fontWeight={700} textAnchor="middle" fill="#3f3f46">End</text>
        </svg>
      ...
      <div>
        <div className="text-xs font-semibold uppercase tracking-wide text-cyan-700 text-center mb-1">
        ...
        <div className="bg-white rounded-md border border-neutral-200 p-3">
          ...
          <div className="text-xs text-neutral-500 text-center mt-1.5">
