function Pill({ label, tone }: { label: string; tone: "cyan" | "orange" | "neutral" }) {
  ...
  return <div className={`px-2 py-1 rounded-md border text-sm text-center ${cls}`}>{label}</div>;
}
...
export function MCPLayerShiftDiagram() {
  return (
    <div className="space-y-2">
      <div>
        <div className="text-sm font-semibold uppercase tracking-wide text-red-700 mb-1 text-center">
          Without MCP
        </div>
        <div className="flex items-stretch gap-1.5">
          <div className="flex-1 rounded-lg border border-neutral-200 bg-neutral-50 p-2 space-y-1">
            <div className="text-sm text-neutral-500 text-center mb-0.5">Client side (your app)</div>
          ...
          <div className="flex-1 rounded-lg border border-neutral-200 bg-neutral-50 p-2 space-y-1">
            <div className="text-sm text-neutral-500 text-center mb-0.5">Server side</div>
      ...
      <div className="flex justify-center text-sm text-neutral-500">↓ the adapter box relocates</div>

      <div>
        <div className="text-sm font-semibold uppercase tracking-wide text-emerald-700 mb-1 text-center">
          With MCP
        </div>
        <div className="flex items-stretch gap-1.5">
          <div className="flex-1 rounded-lg border border-neutral-200 bg-neutral-50 p-2 space-y-1">
